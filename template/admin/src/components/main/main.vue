    ...
    menuList() {
      ...
      // 用户管理保留
      {
        ...
        "children": [{
          ...
          "is_header": 0,
          "children": [{
            "path": "/admin/user/grade/type",
            "title": "会员类型",
            "icon": "",
            "header": "",
            "is_header": 0
          }, {
            "path": "/admin/user/grade/right",
            "title": "会员权益",
            "icon": "",
            "header": "",
            "is_header": 0
          }, {
            "path": "/admin/user/grade/agreement",
            "title": "会员协议",
            "icon": "",
            "header": "",
            "is_header": 0
          }, {
            "path": "/admin/user/grade/card",
            "title": "卡密会员",
            "icon": "",
            "header": "",
            "is_header": 0
          }, {
            "path": "/admin/user/grade/record",
            "title": "会员记录",
            "icon": "",
            "header": "",
            "is_header": 0
          }, {
            "path": "/admin/user/grade/list",
            "title": "会员卡列表",
            "icon": "",
            "header": "",
            "is_header": 0,
      ...
      // 设置管理保留
      {
        ...
        "children": [{
          ...
          "children": [{
            ...
            "path": "/admin/setting/pages/special/diy",
            "title": "专题页编辑",
            "icon": "",
            "header": "",
            "is_header": 0,
            ...
            "path": "/admin/setting/system_group_data",
            "title": "数据配置",
            "icon": "",
            "header": "system",
            "is_header": 1
          }, {
            "path": "/admin/setting/pages/special",
            "title": "专题页设计",
            "icon": "",
            "header": "",
            "is_header": 0
            ...
            "path": "/admin/setting/system_group_data/kf_adv",
            "title": "客服页面广告",
            "icon": "",
            "header": "",
            "is_header": 0
          }, {
            "path": "/admin/setting/userAgreement/index",
            "title": "隐私协议",
            "icon": "",
            "header": "",
            "is_header": 0
      ...
      menus = this.$store.state.menus.menusName
