<template>
  <div class="chat-box">
    ...
    <div class="tool-wrapper" v-if="isTool">
      <div class="tool-item">
        <Upload :show-upload-list="false" :action="fileUrl" class="mr10 mb10" :before-upload="beforeUpload" :data="uploadData" :headers="header" :multiple="true" :on-success="handleSuccess" :format="['jpg','jpeg','png','gif']" :on-format-error="handleFormatError" style="margin-top: 1px;display: inline-block">
