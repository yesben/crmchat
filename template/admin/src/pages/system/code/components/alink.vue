<template>
    <div class="content">
        ...
        <textarea id="NormalCodeTextarea1" class="code" rows="4">{{siteUrl}}/chat/index?noCanClose=1&token={{tokeninfo.token_md5}}</textarea>
        ...
        <div  class="fenlei">
            <div class="code-content-wrap">
        <textarea id="NormalCodeTextarea2" class="code" rows="4">{{siteUrl}}/chat/pc?noCanClose=1&token={{tokeninfo.token_md5}}</textarea>
                <div class="other-wrap">
        ...
        <div  class="fenlei">
            <div class="code-content-wrap">
        <textarea id="NormalCodeTextarea3" class="code" rows="4">{{siteUrl}}/chat/mobile?noCanClose=1&token={{tokeninfo.token_md5}}</textarea>
            <div class="other-wrap">
