	...
	<div class="container">
		<lay-out>
			<div slot="content">
				...
				<div class="box">
					<div class="img" @click="setting"><image :src="customerServerData.avatar" mode=""></image></div>
					<div>
						<div class="box_font1">
							<span>{{ customerServerData.nickname }}</span>
							<span class="isOnline" :class="{ online: customerServerData.online == '1' }" @click="handleChangeOnline">
								<span></span>
								...
								<span class="onLineModel" v-if="onlineModel">
									...
									<span class="model_text" @click="online(1)">
										...
										<span>在线</span>
										<span class="iconfont" :class="{ opacity0: !(customerServerData.online == '1') }">&#xe6d1;</span>
									</span>
									<span class="xian"></span>
									<span class="model_text" @click="online(0)">
										<span class="dian"></span>
										<span>离线</span>
										<span class="iconfont" :class="{ opacity0: !(!customerServerData.online || customerServerData.online == '0') }">&#xe6d1;</span>
									</span>
								</span>
				...
				<div class="content">
					...
					<div class="line"></div>
					<div class="content_box" @click="editDominName">
						<div class="icon"><span class="iconfont iconPrimaryColor">&#xe6f9;</span></div>
...
<script>
import { navigateTo, Modal } from 'pages/utils/uniApi.js';
