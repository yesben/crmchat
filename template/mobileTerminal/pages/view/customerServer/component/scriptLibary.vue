	...
	<div class="scriptLibary_container" :style="{ 'max-height': maxHeight, height: height }">
		<div class="script_group">
			<scroll-view scroll-y="true" class="script_group_scroll">
				<!-- 	<div class="tag_list flex-center" @click="addGroup">
		...
		<div class="script_list">
			<scroll-view scroll-y="true" class="script_list_scroll">
				<div class="add_script" v-if="!icCanEdit" @click="addSpeech">
				...
				<div class="script_list_item" v-for="(item, index) in scriptList" :key="index" @click="selectScript(item)">
					...
					<div class="edit_box" v-if="icCanEdit">
						<div @click="editSpeech(item)"><span class="iconfont">&#xe6b2;</span></div>
						<div @click="handleDeleteServiceSpeechcraft(item)"><span class="iconfont">&#xe6b3;</span></div>
					</div>
				</div>
			</scroll-view>
		</div>
...
<script>
import { Toast, throttle, serialize, Modal } from 'pages/utils/uniApi.js';
