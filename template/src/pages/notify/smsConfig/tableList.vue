<template>
    <div>
        <Card :bordered="false" dis-hover>
            ...
            <div v-else>
                <!--开通按钮-->
                <div v-if="(isChecked === '1' && !isSms) || (isChecked === '2' && !isDump) || (isChecked === '3' && !isLogistics) || (isChecked === '4' && !isCopy)" class="wuBox acea-row row-column-around row-middle">
                ...
                <div class="smsBox" v-if="isDump && isChecked === '2'">
                    <div class="index_from page-account-container">
                        ...
                        <Form ref="formInlineDump" :model="formInlineDump" :rules="ruleInlineDump" @submit.native.prevent @keyup.enter="handleSubmitDump('formInlineDump')">
                            ...
                            <FormItem class="maxInpt">
                                <Button type="primary" long size="default" @click="handleSubmitDump('formInlineDump')" class="btn">立即开通</Button>
                            </FormItem>
                        </Form>
                    </div>
                </div>
...
<script>
    import { smsRecordApi, serveInfoApi, serveSmsOpenApi, serveOpnExpressApi, serveOpnOtherApi, serveRecordListApi, exportTempApi, exportAllApi, serveSign, captchaApi, serveOpen } from '@/api/setting';
    export default {
        name: 'tableList',
        props: {
            copy: {
