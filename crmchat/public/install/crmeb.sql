...
INSERT INTO `eb_application` VALUES (3,'客服','202116257358989495','da52ac13388dbbfe45f34315f580e31e','http://chat.lfmn.fun/uploads/attach/2021/07/20210708/90d8b487cea7ea2545cafcbafb6f6735.jpg','',1625735898,9495,'',0,'2021-07-08 17:18:18','2021-07-08 17:18:18');
...
INSERT INTO `eb_cache` VALUES ('kf_adv','\"<p><strong>\\u8fd9\\u5c31\\u662f\\u4e00\\u4e2a\\u6d4b\\u8bd5\\u754c\\u9762\\uff0c\\u60f3\\u4e86\\u89e3\\u66f4\\u591a\\u8bf7\\u5173\\u6ce8\\u6211\\u4eec<\\/strong><br\\/><\\/p>\"',0,1626662767),('1626687159260','[]',0,1626687195),('1626688474295','[]',0,1626688641),('1626688768266','[]',0,1626688772),('1626689093881','[]',0,1626689097),('1626689329899','[]',0,1626689332),('1626689363340','[]',0,1626689365),('1626689403403','[]',0,1626689414),('1626689691151','[]',0,1626689696),('1626689911435','[]',0,1626689915),('1626690375814','[]',0,1626690379),('1626690472356','[]',0,1626690478),('1626690679734','[]',0,1626690684),('1626690802253','[]',0,1626690809),('1626690876374','[]',0,1626690882),('1626690900958','[]',0,1626690906),('1626691021720','[]',0,1626691029),('1626691094944','[]',0,1626691099),('1626691128973','[]',0,1626691133),('1626691173610','[]',0,1626691179),('1626691262151','[]',0,1626691266),('1626691342329','[]',0,1626691356),('1626691439364','[]',0,1626691461),('1626691483387','[]',0,1626691489),('1626691516412','[]',0,1626691518),('1626691582791','[]',0,1626691584);
...
CREATE TABLE IF NOT EXISTS `eb_chat_service` (
  ...
  KEY `account` (`account`),
  KEY `phone` (`phone`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='客服表';
...
) ENGINE=InnoDB AUTO_INCREMENT=793 DEFAULT CHARSET=utf8mb4 COMMENT='客服用户';
...
INSERT INTO `eb_system_admin` VALUES (1,'admin','','$2y$10$/BM3hGVZN2wq2gPXYIJZB.9YGwaTO/xM2NVz/k71dfWkmJpQCOGuS','','','1.80.118.27',1626743067,0,73,0,1,0),(2,'15594500161','','$2y$10$XwC9ixCUIoimcZDKZMU5BeAAVDsygWYEWtj7R4uvm9rsb08XD12mm','15594500161','1','',0,1626409708,0,1,1,0),(3,'cease','','$2y$10$1E.OigyP0EPOzeF47eR8J.LOmtJMkTGE2DLwRYWjyLgnmo3qMLfpS','wu','1','',0,1626418544,0,1,0,1);
...
CREATE TABLE IF NOT EXISTS `eb_system_attachment` (
  ...
  PRIMARY KEY (`att_id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COMMENT='附件管理表';
...
CREATE TABLE IF NOT EXISTS `eb_system_config` (
  ...
  PRIMARY KEY (`id`),
  KEY `key_status` (`menu_name`,`status`),
...
INSERT INTO `eb_system_config` VALUES (1,'site_name','text','input',1,'',0,'required:true',100,0,'\"CRMEB\"','网站名称','网站名称很多地方会显示的，建议认真填写',10,1),(2,'site_url','text','input',1,'',0,'required:true,url:true',100,0,'\"http:\\/\\/chat.lfmn.fun\"','网站地址','安装自动配置，不要轻易修改，更换会影响网站访问、接口请求、本地文件储存、支付回调、微信授权、支付、小程序图片访问、部分二维码、官方授权等',5,1),(3,'site_logo','upload','',1,'',1,'',0,0,'\"http:\\/\\/chat.lfmn.fun\\/uploads\\/attach\\/2021\\/07\\/20210717\\/fb2c034652f6f995be83d5818955adbb.jpg\"','后台大LOGO','菜单展开左上角logo,建议尺寸[170*50]',3,1),(5,'seo_title','text','input',1,'',0,'required:true',100,0,'\"CRMEB\"','SEO标题','SEO标题',0,0),(108,'upload_type','radio','',31,'1=>本地存储\n2=>七牛云存储\n3=>阿里云OSS\n4=>腾讯COS',1,'',0,0,'1','上传类型','文件储存配置，注意：一旦配置就不要轻易修改，会导致文件不能使用',40,1),(109,'uploadUrl','text','input',32,'',0,'url:true',100,0,'\"\"','空间域名 Domain','空间域名 Domain',0,1),(110,'accessKey','text','input',32,'',0,'',100,0,'\"\"','AccessKey ID','AccessKey ID',0,1),(111,'secretKey','text','input',32,'',0,'',100,0,'\"\"','AccessKey Secret','AccessKey Secret',0,1),(112,'storage_name','text','input',32,'',0,'',100,0,'\"\"','Bucket','存储空间名称',0,1),(118,'storage_region','text','input',32,'',0,'',100,0,'\"\"','Endpoint','所属地域',0,1),(142,'tengxun_map_key','text','input',68,'',0,'',100,0,'','腾讯地图KEY','腾讯地图KEY，申请地址：https://lbs.qq.com',0,1),(144,'cache_config','text','input',1,'',0,'',100,0,'\"86400\"','网站缓存时间','配置全局缓存时间（秒），默认留空为永久缓存',0,1),(168,'site_logo_square','upload','',1,'',1,'',0,0,'\"http:\\/\\/chat.lfmn.fun\\/uploads\\/attach\\/2021\\/07\\/20210717\\/133abe51cd3285b02fa278f0c57a5323.jpg\"','后台小LOGO','后台菜单缩进小LOGO，尺寸180*180',1,1),(171,'login_logo','upload','',26,'',1,'',0,0,'\"http:\\/\\/chat.lfmn.fun\\/uploads\\/attach\\/2021\\/07\\/20210708\\/90d8b487cea7ea2545cafcbafb6f6735.jpg\"','后台登录页LOGO','后台登录页LOGO，建议尺寸270x75',4,1),(172,'qiniu_uploadUrl','text','input',33,'',0,'',100,0,'\"\"','空间域名 Domain','空间域名 Domain',0,1),(173,'qiniu_accessKey','text','input',33,'',0,'',100,0,'\"\"','accessKey','accessKey',0,1),(174,'qiniu_secretKey','text','input',33,'',0,'',100,0,'\"\"','secretKey','secretKey',0,1),(175,'qiniu_storage_name','text','input',33,'',0,'',100,0,'\"\"','空间名称','存储空间名称',0,1),(176,'qiniu_storage_region','text','input',33,'',0,'',100,0,'\"\"','存储区域','所属地域',0,1),(177,'tengxun_uploadUrl','text','input',34,'',0,'',100,0,'\"\"','空间域名 Domain','空间域名 Domain',0,1),(178,'tengxun_accessKey','text','input',34,'',0,'',100,0,'\"\"','SecretId','SecretId',0,1),(179,'tengxun_secretKey','text','',34,'',0,'',100,0,'\"\"','SecretKey','SecretKey',0,1),(180,'tengxun_storage_name','text','input',34,'',0,'',100,0,'\"\"','存储桶名称','存储桶名称',0,1),(181,'tengxun_storage_region','text','input',34,'',0,'',100,0,'\"\"','所属地域','所属地域',0,1),(305,'service_feedback','textarea','',69,'',0,'',100,7,'\"\\u5c0a\\u656c\\u7684\\u7528\\u6237\\uff0c\\u5ba2\\u670d\\u5f53\\u524d\\u4e0d\\u5728\\u7ebf\\uff0c\\u6709\\u95ee\\u9898\\u8bf7\\u7559\\u8a00\\uff0c\\u6211\\u4eec\\u4f1a\\u7b2c\\u4e00\\u65f6\\u95f4\\u8fdb\\u884c\\u5904\\u7406\\uff01\\uff01\\uff01\"','客服反馈','客服反馈头部文字',0,1),(323,'tourist_avatar','upload','',69,'',2,'',0,0,'[\"http:\\/\\/chat.lfmn.fun\\/uploads\\/attach\\/2021\\/07\\/20210715\\/cadde5e778f14040c06279d944f5b057.png\",\"http:\\/\\/chat.lfmn.fun\\/uploads\\/attach\\/2021\\/07\\/20210715\\/c77ed1c7149ef8c346b900d118b0e828.png\",\"http:\\/\\/chat.lfmn.fun\\/uploads\\/attach\\/2021\\/07\\/20210715\\/b7a19a4382bf9055eeb2041071150245.png\",\"http:\\/\\/chat.lfmn.fun\\/uploads\\/attach\\/2021\\/07\\/20210715\\/d8ca0b0a0a7f472897bcb7eedae778e4.png\"]','客服游客头像','客服游客头像',0,1);
...
INSERT INTO `eb_system_config_tab` VALUES (1,0,'基础配置','basics',1,0,'ios-settings',0,100),(17,0,'文件上传配置','upload_set',1,0,'md-cloud-upload',0,0),(31,17,'基础配置','base_config',1,0,'',0,0),(32,17,'阿里云配置','aliyun_uploads',1,0,'',0,0),(33,17,'七牛云配置','qiniu_uplaods',1,0,'',0,0),(34,17,'腾讯云配置','tengxun_uploads',1,0,'',0,0),(69,22,'客服端配置','kefu_config',1,0,'',0,0);
...
CREATE TABLE IF NOT EXISTS `eb_system_log` (
  ...
  KEY `type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=7857 DEFAULT CHARSET=utf8mb4 COMMENT='管理员操作记录表';
