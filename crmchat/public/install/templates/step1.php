...
<strong>CRMChat客服系统（以下称“CRMChat”），由西安众邦网络科技有限公司（以下称“众邦科技”）独创开发，版权所有Copyright (c)2014-2024，众邦科技保留所有权利。CRMChat基于 PHP + MySQL 的技术，采用ThinkPHP框架开发。CRMChat官方对此拥有最终修改权和解释权。</strong>
CRMChat官方网站：http://www.crmeb.com
<strong>在使用CRMChat客服系统（以下称“许可软件”或“本软件”）之前，请您仔细阅读本协议，特别是法律适用和争议解决条款，此等条款将以粗体标识，您需要重点阅读。如您对协议有任何疑问，可向客服咨询。如果您已下载、复制、安装或以其他任何方式使用该软件，则视为已经接受本协议。如果您不接受本协议的全部或部分条款，您将无权使用本软件。请立即终止安装、或以其他方式使用该软件，删除您已经安装或保留的该软件的任何组件。</strong>
...
<br/>
一、定义
软件（许可软件或本软件）：本协议中的“软件”是指CRMChat客服系统，由若干模块或功能组成的已经植入或即将植入众邦科技指定产品内的信息处理程序或支持文件，其中支持文件具体包括软件的源代码、目标码以及相关软件中所包含的图片、照片、图标、动画、录音、录像、音乐、文字、代码的全部或部分，还包括与许可软件或众邦产品相关的所有描述其功能、特点、内容、质量、测试、用户手册、用户许可协议等纸质或电子版的资料、技术文档等。
您：本协议中的“您”是指取得众邦科技合法许可使用本软件权利的个人或单个法人实体，法人实体包括公司、企业、机构、组织或单位。
我们：本协议中的“我们”即是CRMChat官方，是指众邦科技，即西安众邦网络科技有限公司及其关联公司。
...
5、授权内容使用权：在取得我们许可后，您拥有使用本软件构建的网站全部内容使用权，并独立承担与之相关法律义务。您可以在协议规定的约束条件下和限制范围内修改 CRMChat 源代码或界面风格以适应您的网站要求，但应保留我们的版权信息。不管你的网站是否整体使用 CRMChat ，还是部份栏目使用 CRMChat，在你使用了 CRMChat 的网站主页上必须加上 CRMChat 官方网址(www.crmeb.com)的链接。
6、在获得商业授权之后，您才可以将本软件应用于商业用途，同时依据所购买的授权类型确定技术支持内容。商业授权用户享有反馈意见和提出建议的权力，相关意见和建议将在我们下一次软件升级中被优先考虑，但我们对此不作承诺或保证。
7、CRMChat著作权已在中华人民共和国国家版权局注册(中国国家版权局著作权登记号 2021SR0276161)，著作权受到法律和国际公约保护。未经我们书面许可，不得删除网站底部及相应的官方链接。购买商业授权请联系众邦科技了解最新说明。
...
6、未经我们书面许可，禁止在 CRMChat 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。
7、您一旦开始确认本协议并安装 CRMChat，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权立即终止授权，责令停止损害，并保留追究相关责任的权力。
<br/>
四、知识产权
